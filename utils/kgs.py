...
class KGs:
    def __init__(self, kg1: KG, kg2: KG, train_links, test_links, valid_links=None, mode='mapping', ordered=True):
        ...
        # folder="D-Y"
        # f = open("../HyperKA/dataset/dbp15k/"+folder+"/ent_ids_1", "w")
        # for item in ent_ids1:
        #     f.write(str(ent_ids1[item]) + "\t" + str(item) + "\n")

        # f = open("../HyperKA/dataset/dbp15k/"+folder+"/ent_ids_2", "w")
        # for item in ent_ids2:
        #     f.write(str(ent_ids2[item]) + "\t" + str(item) + "\n")

        # f = open("../HyperKA/dataset/dbp15k/"+folder+"/rel_ids_1", "w")
        # for item in rel_ids1:
        #     f.write(str(rel_ids1[item]) + "\t" + str(item) + "\n")

        # f = open("../HyperKA/dataset/dbp15k/"+folder+"/rel_ids_2", "w")
        # for item in rel_ids2:
        #     f.write(str(rel_ids2[item]) + "\t" + str(item) + "\n")

        # f = open("../HyperKA/dataset/dbp15k/"+folder+"/triples_1", "w")
        # for item in id_relation_triples1:
        #     f.write(str(item[0]) + "\t" +str(item[1])+"\t"+str(item[2]) + "\n")

        # f = open("../HyperKA/dataset/dbp15k/"+folder+"/triples_2", "w")
        # for item in id_relation_triples2:
        #     f.write(str(item[0]) + "\t" +str(item[1])+"\t"+str(item[2]) + "\n")
        ...
        # f = open("../HyperKA/dataset/dbp15k/"+folder+"/ref_pairs", "w")
        # for item in self.test_links:
        ...
        # f = open("../HyperKA/dataset/dbp15k/"+folder+"/sup_pairs", "w")
        # for item in self.train_links:
        #     f.write(str(item[0]) + "\t" +str(item[1]) + "\n")
